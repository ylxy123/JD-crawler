...
"color: rgb(255, 255, 255);")
        ...
        self.widget.setGeometry(QtCore.QRect(290, 100, 460, 31))
        ...
        self.additembtn = QtWidgets.QPushButton(self.widget)
        ...
        self.searchCartbtn = QtWidgets.QPushButton(self.widget)
        ...
        self.widget1 = QtWidgets.QWidget(JD)
        self.widget1.setGeometry(QtCore.QRect(600, 60, 136, 26))
        ...
        self.buynumEdit = QtWidgets.QLineEdit(self.widget1)
        self.buynumEdit.setStyleSheet("background-color: rgb(211, 211, 211);")
        self.buynumEdit.setObjectName("buynumEdit")
        self.horizontalLayout_2.addWidget(self.buynumEdit)
        self.widget2 = QtWidgets.QWidget(JD)
        self.widget2.setGeometry(QtCore.QRect(300, 60, 291, 26))
        ...
        self.goodsEdit = QtWidgets.QLineEdit(self.widget2)
        ...
        self.label_3.raise_()
        self.searchCartbtn.raise_()
        self.label_4.raise_()
        self.line_9.raise_()
        self.relogbtn.raise_()
        self.label_5.raise_()
        self.buynumEdit.raise_()
